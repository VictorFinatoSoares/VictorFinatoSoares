...
Through the course and my own studies, I'm developing knowledge in areas such as:
...
It allows users to search for a GitHub username and retrieve information about that profile using the GitHub API.

Through this project, I practiced concepts such as:
...
In the long term, I want to use that experience to build products and solutions of my own.
